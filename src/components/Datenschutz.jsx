...
const Datenschutz = () => {
  return (
    <div className="w-full  bg-gradient-to-b from-black to-gray-800 p-4 text-white">
      <div className="flex flex-col p-4 gap-6 justify-center max-w-screen-lg mx-auto h-full ">
        ...
        <h3 className="font-semibold text-xl">Allgemeine Hinweise</h3>
        <p>
        ...
        <p className="font-semibold text-lg">Wie erfassen wir ihre Daten?</p>
        <p>
        ...
        <p className="font-semibold text-lg">Wofür nutzen wir ihre Daten?</p>
        <p>
        ...
        <h2 className="font-semibold text-2xl">2. Hosting</h2>
        <p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter: </p>
        <h3 className="font-semibold text-xl">Externes Hosting</h3>
        <p>
        ...
        <p>
          Weiter Hinweise zum Datenschutz von Netlify erhalten Sie unter der
          nachstehenden Internetseite: https://www.netlify.com​/gdpr-ccpa{" "}
        </p>
        <h2 className="font-semibold text-2xl">
          3. Allgemeine Hinweise und Pflichtinformationn
        </h2>
        <h3 className="font-semibold text-xl">Datenschutz</h3>
        <p>
        ...
        <p>04315 Leipzig</p>
        <p>Telefon: +49 15224829410</p>
        <p>E-Mail: alexander.niehaus@gmx.net</p>
        <p>
        ...
        <h3 className="font-semibold text-xl">Speicherdauer</h3>
        <p>
