  ...
  return (
    <div className="w-full  bg-gradient-to-b from-black to-gray-800 p-4 text-white">
      <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full ">
        ...
        <br />
        <br />
        <h2>3. Allgemeine Hinweise und Pflichtinformationn</h2>
        <br />
        <br />
        <h3>Datenschutz</h3>
        <br />
        ...
        <p>
          ...
          erfolgt die Löschung nach Fortfall dieser Gründe. Allgemeine Hinweise
          zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website
        </p>
        ...
        die Einwilligung ist jederzeit widerrufbar. Die von Ihnen an uns per
